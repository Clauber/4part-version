...
const yargs = require('yargs')
  ...
  .option('release-as', {
    alias: 'r',
    type: 'string',
    choices: ['major', 'minor', 'patch', 'revision'],
    describe: 'Specify the release type manually (major, minor, patch, or revision)'
  })
  .option('release-version', {
    alias: 'rv',
    type: 'string',
    describe: 'Specify a specific version (e.g., 1.2.3 or 1.2.3.4)'
  })
  .option('prerelease', {
    alias: 'p',
